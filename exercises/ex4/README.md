# Exercise 4 - Build the Model: Create Transformation Model & Version
...
1.  Within your confirmed blueprint, choose **Create Transformation Model**.<br><br>
    ![](/exercises/ex4/images/Screenshot-01.png)<br>

2.  The **Manage Transformation Models** application opens, with your blueprint already preselected.<br>
3.  Enter **TRF_MDL_CS162_XX** (replace *XX* with your seat number, for example **TRF_MDL_CS162_01**) as **Title** and choose **Create**.<br><br>
    ![](/exercises/ex4/images/Screenshot-02.png)<br>
...
4.  After a few seconds, the **Transformation Model** is successfully created.<br>
    ...
    ![](/exercises/ex4/images/Screenshot-03.png)<br>
...
5.  Choose **Transformation Objects** [1] and search for **FI Document** [2]. Then scroll down and click the **Name** of the **FI Document** [3] transformation object to navigate into it.<br><br>
    ![](/exercises/ex4/images/Screenshot-04.png)<br>
...
6.  The details of the **FI Document** appear. Choose **Filters**.<br><br>
    ...
    ![](/exercises/ex4/images/Screenshot-05.png)<br>

7.  Use the **Back** button to return to the transformation model overview.<br><br>
    Choose **Transformation Filters** tab [1] and then open the **Company Code Filter** [2] with the ID EccCompanyCodeFilter that belongs to the solution pattern **Org Slice**.<br><br>
    ![](/exercises/ex4/images/Screenshot-06.png)<br>

8.  The filter details open, showing that the value is set to company code **2000** — as scoped in your blueprint.<br><br>
    ![](/exercises/ex4/images/Screenshot-07.png)<br>
...
9.  Next, open the **Fiscal Year Greater Than or Equal To Filter** with the ID EccFiscalYearGreaterEquals.<br><br>
    ...
    ![](/exercises/ex4/images/Screenshot-08.png)<br>
...
13. In the **Review Custom Transformation Objects** dialog, deselect **Change Document – HOLIDAYCAL** from the list and choose **Save**.<br><br>
    ...
    ![](/exercises/ex4/images/Screenshot-11.png)<br>

14. Then, choose **Create Version**.<br><br>
    ![](/exercises/ex4/images/Screenshot-12.png)<br>
...
16. Enter **MDL_V1** as **Title** and choose **Create**.<br><br>
    ![](/exercises/ex4/images/Screenshot-13.png)<br>
...
17. After a few seconds, the **Transformation Model Version** is successfully created.<br><br>
    ...
    ![](/exercises/ex4/images/Screenshot-14.png)<br>

18. **Congratulations!** You have successfully completed this exercise.<br><br><br>

## Optional: Test Your Knowledge
Run this optional [quiz](https://quiz-app-gk8jvkhz.cfapps.eu10-005.hana.ondemand.com/cs162in/quiz/a0t50de2) to test your understanding. If you prefer to skip it, continue with the next exercise.<br>
...
Continue to - [Exercise 5 - Initialize Cycle: Create Cycle & Run Prevalidation](../ex5/README.md)
