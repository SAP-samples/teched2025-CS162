# Exercise 5 - Initialize Cycle: Create Cycle & Run Prevalidation
...
3.  Maintain the following details in the **Cycle Attributes** and **System Connection** sections, then choose Create:<br>
    - **Name**: **CYCLE_CS162_XX** (replace *XX* with your exercise number, for example **CYCLE_CS162_01**)
    - **Type**: **Test**
...
Run this optional [quiz](https://quiz-app-gk8jvkhz.cfapps.eu10-005.hana.ondemand.com/cs162/quiz/mqs74iau) to test your understanding. If you prefer to skip it, continue with the next exercise.<br>
...
Continue to - [Exercise 6 - Execute Data Validation: Configure DTV Project & Monitor Cycle](../ex6/README.md)
