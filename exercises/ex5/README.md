...
3.  Maintain the following details in the **Cycle Attributes** and **System Connection** sections, then choose Create:<br>
    - **Name**: **CYCLE_CS162_XX** (replace *XX* with your seat number, for example **CYCLE_CS162_01**)
    - **Type**: **Test**
...
Run this optional [quiz](https://quiz-app-gk8jvkhz.cfapps.eu10-005.hana.ondemand.com/cs162in/quiz/k0po4tfc) to test your understanding. If you prefer to skip it, continue with the next exercise.<br>
